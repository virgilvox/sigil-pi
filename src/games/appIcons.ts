...
export const APP_ICONS: Record<string, string> = {
  ...
  // thermal printer — feed sheet in, body, printed slip with text lines + status LED
  'platen': '<path d="M32 38 L32 22 L68 22 L68 38"/><rect x="20" y="38" width="60" height="26" rx="4"/><rect x="32" y="58" width="36" height="26" rx="2"/><path d="M39 66 L61 66 M39 73 L55 73"/><circle cx="70" cy="51" r="2.5" fill="currentColor"/>',
